...
eval $(opam env) dune exec -- ./live_test.exe 4 -c -t 10 -r 100 -b 100 --times "./experiments/data/mininet/subtests/100tp100b.csv" --stats "./experiments/data/mininet/stats.csv"