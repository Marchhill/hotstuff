...
\begin{figure}[h!]
\centering
\input{images/batch_size_test/throughputgoodput.pgf}
...
\begin{figure}[h!]
\centering
\input{images/batch_size_test/goodputlatency.pgf}
...
% \begin{figure}[h!]
% \centering
% \input{images/batch_size_test/goodput95latency.pgf}
...
\begin{figure}[h!]
\centering
\input{images/node_count_test/throughputgoodput_nodes.pgf}
...
\begin{figure}[h!]
\centering
\input{images/node_count_test/goodputlatency_nodes.pgf}
...
\begin{figure}[h!]
\centering
\input{images/ablation/throughputgoodput_ablation.pgf}
...
\begin{figure}[h!]
\centering
\input{images/ablation/goodputlatency_ablation.pgf}
