...
\item New-view: 
	\begin{enumerate}
	\item leader $\to$ replicas: ``view = 3" 
	\item replicas $\to$ leader: ``log = [`hello', `world']", \dots
	\item leader: waits $\Delta$ to hear from all replicas
	\end{enumerate}
\item Prepare:
	\begin{enumerate}
