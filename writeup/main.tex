...
\newtheorem{threat}{Threat}[section]
...
\noindent Date: 11\textsuperscript{th} May 2023
...
Word Count:         & \bf 11,843\footnotemark[1] \\
Code line Count:    & \bf 4,190\footnotemark[2] \\
Project Originator: & Christopher Jensen and the candidate \\
...
This project includes a full specification of the HotStuff algorithm, filling in the gaps from the original paper with other protocols from the literature, and my changes. My implementation of the algorithm is correct and includes several optimisations, which are shown to be effective in an evaluation. I synthesised information from the literature to give a full explanation of the algorithm and how it can be logically derived from additions to simpler consensus algorithms. This project paves the way for future HotStuff implementations by describing non-trivial challenges that were encountered during development and giving solutions and practical optimisations.
