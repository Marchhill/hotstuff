...
let%expect_test "leader + replicas can commit client commands and respond" =
  ...
  exec ([]-["hello2#2",]-[]-[]-⊥)
  view 7:
  state id=3 view=7 qc_high=(view=5 type=generic_ack node=(["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=(hello4#4,) v=[]
  state id=2 view=7 qc_high=(view=6 type=generic_ack node=([]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  send_client id="3"
  view 8:
  state id=3 view=8 qc_high=(view=7 type=generic_ack node=([]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=8 qc_high=(view=6 type=generic_ack node=([]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  send_client id="1"
  view 9:
  state id=3 view=9 qc_high=(view=7 type=generic_ack node=([]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=9 qc_high=(view=7 type=generic_ack node=([]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  exec ([]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥)
  view 10:
  state id=3 view=10 qc_high=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=10 qc_high=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=1 view=10 qc_high=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=0 view=10 qc_high=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  1: reset_timer view=10
  1: broadcast view=10 src=1 type=generic node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) justify=() sig=(#1) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 11:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  exec ([]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥)
  view 11:
  state id=3 view=11 qc_high=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=11 qc_high=(view=10 type=generic_ack node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  send_client id="4"
  view 12:
  state id=3 view=12 qc_high=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=12 qc_high=(view=10 type=generic_ack node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  exec ([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥)
  view 13:
  state id=3 view=13 qc_high=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=13 qc_high=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  exec ([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥)
  view 14:
  state id=3 view=14 qc_high=(view=12 type=generic_ack node=([]-[]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=14 qc_high=(view=12 type=generic_ack node=([]-[]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=1 view=14 qc_high=(view=13 type=generic_ack node=([]-[]-[]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=0 view=14 qc_high=(view=12 type=generic_ack node=([]-[]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  1: reset_timer view=14
  1: broadcast view=14 src=1 type=generic node=([]-[]-[]-[]-[]-[]-⊥) justify=() sig=(#1) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 15:@.";
  ...
  exec ([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥)
  view 15:
  state id=3 view=15 qc_high=(view=13 type=generic_ack node=([]-[]-[]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=15 qc_high=(view=14 type=generic_ack node=([]-[]-[]-[]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
...
let%expect_test "failed view still commits command" =
  ...
  3: reset_timer view=8
  3: broadcast view=8 src=3 type=generic node=([]-[]-[]-[]-[]-[]-["hello2#6",]-[]-[]-⊥) justify=() sig=(#3) |}];
	let nodes, actions = view nodes actions in
	List.iter print_state nodes;
	List.iter print_action actions;
	[%expect {|
  ...
  state id=2 view=9 qc_high=(view=7 type=generic_ack node=([]-[]-[]-[]-[]-["hello2#6",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  ...
  exec ([]-[]-[]-[]-["hello2#6",]-[]-[]-⊥)
  exec ([]-[]-[]-[]-["hello2#6",]-[]-[]-⊥)
  state id=3 view=10 qc_high=(view=8 type=generic_ack node=([]-[]-[]-[]-[]-[]-["hello2#6",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=2 view=10 qc_high=(view=8 type=generic_ack node=([]-[]-[]-[]-[]-[]-["hello2#6",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=1 view=10 qc_high=(view=9 type=generic_ack node=([]-[]-[]-[]-[]-[]-[]-["hello2#6",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  state id=0 view=10 qc_high=(view=8 type=generic_ack node=([]-[]-[]-[]-[]-[]-["hello2#6",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=() v=[]
  1: reset_timer view=10
  1: broadcast view=10 src=1 type=generic node=([]-[]-[]-[]-[]-[]-⊥) justify=() sig=(#1) |}]