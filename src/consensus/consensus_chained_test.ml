...
let%expect_test "failed view still commits command" =
  ...
  state id=0 view=6 qc_high=(view=2 type=generic_ack node=(["hello2#6",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  1: reset_timer view=6
...
let%expect_test "conflicting proposal not voted for." =
  ...
  state id=0 view=8 qc_high=(view=6 type=generic_ack node=([]-[]-[]-[]-[]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  3: send_next_leader view=8 src=3 type=new_view node=(⊥) justify=(view=7 type=generic_ack node=([]-[]-[]-[]-[]-[]-[]-[]-⊥) sig=(#3,#2,#1)) sig=(#3)
  3: reset_timer view=9
  2: send_next_leader view=8 src=2 type=new_view node=(⊥) justify=(view=6 type=generic_ack node=([]-[]-[]-[]-[]-[]-[]-⊥) sig=(#3,#2,#1)) sig=(#2)
  2: reset_timer view=9
  1: send_next_leader view=8 src=1 type=new_view node=(⊥) justify=(view=6 type=generic_ack node=([]-[]-[]-[]-[]-[]-[]-⊥) sig=(#3,#2,#1)) sig=(#1)
  1: reset_timer view=9
  0: send_next_leader view=8 src=0 type=new_view node=(⊥) justify=(view=6 type=generic_ack node=([]-[]-[]-[]-[]-[]-[]-⊥) sig=(#3,#2,#1)) sig=(#0) |}]
