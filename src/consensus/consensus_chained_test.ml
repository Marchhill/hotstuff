...
let%expect_test "single view" =
  ...
  3: send_next_leader view=1 src=3 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
  3: reset_timer view=2
  3: send_next_leader view=1 src=3 type=new_view node=(⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
  2: send_next_leader view=1 src=2 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
  2: reset_timer view=2
  2: send_next_leader view=1 src=2 type=new_view node=(⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
  1: send_next_leader view=1 src=1 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
  1: send_next_leader view=1 src=1 type=new_view node=(⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
  0: send_next_leader view=1 src=0 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(⊥)
...
let%expect_test "single view w/crypto" =
  ...
  state id=1 view=1 qc_high=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) cmd=() v=[]
  state id=0 view=2 qc_high=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) cmd=() v=[]
  3: send_next_leader view=1 src=3 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#3)
  3: reset_timer view=2
  3: send_next_leader view=1 src=3 type=new_view node=(⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#3)
  2: send_next_leader view=1 src=2 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#2)
  2: reset_timer view=2
  2: send_next_leader view=1 src=2 type=new_view node=(⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#2)
  1: send_next_leader view=1 src=1 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#1)
  1: send_next_leader view=1 src=1 type=new_view node=(⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#1)
  0: send_next_leader view=1 src=0 type=generic_ack node=([]-[]-⊥) justify=(view=0 type=generic_ack node=([]-⊥) sig=(⊥)) sig=(#0)
  0: reset_timer view=2
...
let%expect_test "leader + replicas can commit client commands and respond" =
  ...
  2: reset_timer view=7
  2: broadcast view=7 src=2 type=generic node=([]-[]-["hello1#1","hello1#0",]-["hello4#3",]-⊥) justify=(view=6 type=generic_ack node=([]-["hello1#1","hello1#0",]-["hello4#3",]-[]-⊥) sig=(#3,#2,#1)) sig=(#2) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 8:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  3: reset_timer view=8
  3: broadcast view=8 src=3 type=generic node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) justify=(view=7 type=generic_ack node=([]-[]-["hello1#1","hello1#0",]-["hello4#3",]-⊥) sig=(#3,#2,#1)) sig=(#3) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 9:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  0: reset_timer view=9
  0: broadcast view=9 src=0 type=generic node=([]-["hello4#4",]-[]-[]-⊥) justify=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) sig=(#0) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 10:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  1: reset_timer view=10
  1: broadcast view=10 src=1 type=generic node=([]-[]-["hello4#4",]-[]-⊥) justify=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-⊥) sig=(#3,#2,#1)) sig=(#1) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 11:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  2: reset_timer view=11
  2: broadcast view=11 src=2 type=generic node=([]-[]-[]-["hello4#4",]-⊥) justify=(view=10 type=generic_ack node=([]-[]-["hello4#4",]-[]-⊥) sig=(#3,#2,#1)) sig=(#2) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 12:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  3: reset_timer view=12
  3: broadcast view=12 src=3 type=generic node=([]-[]-[]-[]-⊥) justify=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-⊥) sig=(#3,#2,#1)) sig=(#3) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 13:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
...
let%expect_test "failed view still commits command" =
  ...
  3: reset_timer view=8
  3: broadcast view=8 src=3 type=generic node=([]-[]-[]-[]-⊥) justify=(view=7 type=generic_ack node=([]-[]-[]-[]-[]-["hello2#6",]-⊥) sig=(#3,#2,#1)) sig=(#3) |}];
	let nodes, actions = view nodes actions in
	List.iter print_state nodes;
	List.iter print_action actions;
	[%expect {|
