...
let%expect_test "leader + replicas can commit client commands and respond" =
  ...
  state id=0 view=9 qc_high=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  0: reset_timer view=9
  0: broadcast view=9 src=0 type=generic node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-⊥) justify=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-⊥) sig=(#3,#2,#1)) sig=(#0) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 10:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  state id=1 view=10 qc_high=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-⊥) sig=(#3,#2,#1)) cmd=()
  state id=0 view=10 qc_high=(view=8 type=generic_ack node=(["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  1: reset_timer view=10
  1: broadcast view=10 src=1 type=generic node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) justify=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-⊥) sig=(#3,#2,#1)) sig=(#1) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 11:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  state id=2 view=11 qc_high=(view=10 type=generic_ack node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) cmd=()
  state id=1 view=11 qc_high=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-⊥) sig=(#3,#2,#1)) cmd=()
  state id=0 view=11 qc_high=(view=9 type=generic_ack node=([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  2: reset_timer view=11
  2: broadcast view=11 src=2 type=generic node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) justify=(view=10 type=generic_ack node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) sig=(#2) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 12:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  send_client id="4"
  view 12:
  state id=3 view=12 qc_high=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) cmd=()
  state id=2 view=12 qc_high=(view=10 type=generic_ack node=([]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) cmd=()
  ...
  3: reset_timer view=12
  3: broadcast view=12 src=3 type=generic node=([]-[]-[]-[]-["hello4#4",]-[]-⊥) justify=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) sig=(#3) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 13:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  exec ([]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-["hello4#3",]-[]-["hello2#2",]-[]-[]-⊥)
  view 13:
  state id=3 view=13 qc_high=(view=11 type=generic_ack node=([]-[]-[]-["hello4#4",]-[]-[]-["hello1#1","hello1#0",]-⊥) sig=(#3,#2,#1)) cmd=()
  ...
  state id=0 view=13 qc_high=(view=12 type=generic_ack node=([]-[]-[]-[]-["hello4#4",]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  0: reset_timer view=13
  0: broadcast view=13 src=0 type=generic node=([]-[]-[]-[]-[]-["hello4#4",]-⊥) justify=(view=12 type=generic_ack node=([]-[]-[]-[]-["hello4#4",]-[]-⊥) sig=(#3,#2,#1)) sig=(#0) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 14:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  state id=1 view=14 qc_high=(view=13 type=generic_ack node=([]-[]-[]-[]-[]-["hello4#4",]-⊥) sig=(#3,#2,#1)) cmd=()
  state id=0 view=14 qc_high=(view=12 type=generic_ack node=([]-[]-[]-[]-["hello4#4",]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  1: reset_timer view=14
  1: broadcast view=14 src=1 type=generic node=([]-[]-[]-[]-[]-[]-⊥) justify=(view=13 type=generic_ack node=([]-[]-[]-[]-[]-["hello4#4",]-⊥) sig=(#3,#2,#1)) sig=(#1) |}];
	let nodes, actions = view nodes actions in
	Fmt.pr "view 15:@.";
	List.iter print_state nodes;
	List.iter print_action actions;
  ...
  state id=2 view=15 qc_high=(view=14 type=generic_ack node=([]-[]-[]-[]-[]-[]-⊥) sig=(#3,#2,#1)) cmd=()
  state id=1 view=15 qc_high=(view=13 type=generic_ack node=([]-[]-[]-[]-[]-["hello4#4",]-⊥) sig=(#3,#2,#1)) cmd=()
