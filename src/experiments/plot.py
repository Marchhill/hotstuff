...
stats['goodputfiltered'] = np.where(stats['throughput'] <= 2000, stats['goodput'], None)
...
stats[['goodputfiltered', 'medianlatency']] = stats[['goodputfiltered', 'medianlatency']].astype(float)
stats[['goodputfiltered', '95latency']] = stats[['goodputfiltered', '95latency']].astype(float)
...
g = sns.lmplot(x='goodputfiltered', y='medianlatency', data=stats, hue='batch_size', palette = color, ci = None, order = 2)
g.legend.remove()
ax = g.axes[0][0]
ax.set(xlabel = 'goodput (req/s)', ylabel = 'median latency (s)', xlim = (0., 1000.), ylim = (0., 1.))
ax.legend(title = 'batch size')
fig = ax.get_figure()
...
g = sns.lmplot(x='goodputfiltered', y='95latency', data=stats, hue='batch_size', palette = color, ci = None, order = 2)
g.legend.remove()
...
g = sns.lmplot(x='goodput', y='medianlatency', data=stats, hue='nodes', palette = color, ci = None, order = 2)
g.legend.remove()
ax = g.axes[0][0]
...
g = sns.lmplot(x='goodput', y='95latency', data=stats, hue='nodes', palette = color, ci = None, order = 2)
g.legend.remove()
ax = g.axes[0][0]
...
g = sns.lmplot(x='goodputfiltered', y='medianlatency', data=stats, hue='version', palette = color, ci = None, order = 2)
g.legend.remove()
ax = g.axes[0][0]
ax.set(xlabel = 'goodput (req/s)', ylabel = 'median latency (s)', ylim = (0., 1.), xscale = 'log')
ax.legend(title = 'version')
...
g = sns.lmplot(x='goodputfiltered', y='95latency', data=stats, hue='version', palette = color, ci = None, order = 2)
g.legend.remove()
ax = g.axes[0][0]
ax.set(xlabel = 'goodput (req/s)', ylabel = '95%ile latency (s)', ylim = (0., 1.), xscale = 'log')
ax.legend(title = 'version')
