...
ax = sns.lineplot(x='throughput', y='mean', data=stats, hue='batch_size', palette = color, linestyle='--')
...
ax = sns.lineplot(x='throughput', y='mean', data=stats, hue='nodes', palette = color, linestyle='--')
ax.set(xlabel = 'throughput (req/s)', ylabel = 'mean latency (ms)')
fig = ax.get_figure()
...
ax = sns.lineplot(x='throughput', y='mean', data=stats, hue='version', palette = color, linestyle='--')
ax.set(xlabel = 'throughput (req/s)', ylabel = 'mean latency (ms)')
fig = ax.get_figure()
