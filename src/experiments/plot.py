...
ax = sns.lineplot(x='throughputfiltered', y='meanlatency', data=stats, hue='chained', palette = color, linestyle='--')
ax.set(xlabel = 'throughput (req/s)', ylabel = 'mean latency (ms)')
ax.legend(title = 'version')
fig = ax.get_figure()
...
ax = sns.lineplot(x='throughput', y='meanlatency', data=stats, hue='chained', palette = color, linestyle='--')
ax.set(xlabel = 'throughput (req/s)', ylabel = 'mean latency (ms)')
fig = ax.get_figure()
